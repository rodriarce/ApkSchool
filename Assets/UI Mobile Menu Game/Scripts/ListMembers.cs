...
public class ListMembers : MonoBehaviour
{
    ...
    public GameObject NormalPrefab;// PRefab LeaderBoard
    public Transform Content;// Prefab Content
    ...
    public class MembersList
    {
        ...
        public string Gain;
        public string coinsChild;
        public string coinsParent;
    ...
    public void SetLeaderBoard()
    {
        for (int i = 0; i < membersList.Count; i++)
        {
            ...
            {
                Member.GetComponent<InitMemberList>().PrefabForRanking(this, membersList[i].id, membersList[i].Login, membersList[i].Level, membersList[i].Gain, membersList[i].rank, membersList[i].avatar, membersList[i].coinsParent, membersList[i].coinsChild);
            }
        }
